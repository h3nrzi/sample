...
- **Operational Needs:** Foreground/daemon execution, clear logging format, configurable default policy, concise rule syntax, Makefile build, tests and documentation.
